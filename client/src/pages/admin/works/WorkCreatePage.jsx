  ...
  return (
    <div className="space-y-6 max-w-4xl font-sans">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-serif font-bold text-gray-800">Thêm Tác Phẩm Văn Học Mới</h1>
          <p className="text-gray-500 text-sm">Nhập nội dung, thể loại và đa phương tiện cho tác phẩm</p>
        </div>
      </div>
